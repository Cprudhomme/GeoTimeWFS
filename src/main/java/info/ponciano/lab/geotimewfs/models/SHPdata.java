...
public class SHPdata {
	...
	private void initAttUpdate() throws Exception {
		...
		this.title = val[0];
		this.prevAsset = "http://lab.ponciano.info/ontology/2020/geotime/dcat#" + val[1];
	...
	/**
	 * Transform a list of string table into a list of string, in which the string
	 * is the concatenation of the table
	 * 
