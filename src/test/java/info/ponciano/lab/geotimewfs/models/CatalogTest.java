...
public class CatalogTest {
    ...
    public CatalogTest() {
        try {
            ...
            link.put("href", "https://geotimewfs.herokuapp.com/api/geotimeWFS/collections/gdi_catalog?f=html");
            link.put("rel", "collection");
            link.put("title", "Root URL for this record collection in HTML");
            jar.put(link);
            link = new JSONObject();
            link.put("href", "https://geotimewfs.herokuapp.com/api/geotimeWFS/collections/gdi_catalog?f=json");
            link.put("rel", "collection");
            link.put("title", "Root URL for this record collection in JSON");
            jar.put(link);
            link = new JSONObject();
            link.put("href", "https://geotimewfs.herokuapp.com/api/geotimeWFS/collections/gdi_catalog?f=xml");
            link.put("rel", "collection");
